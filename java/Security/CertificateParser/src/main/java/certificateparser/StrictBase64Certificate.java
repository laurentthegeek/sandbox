...
public class StrictBase64Certificate
{
    public static void main(String[] args)
    {
        try
        {
            ...
            // converts raw base 64 to PEM (without line breaks) and generates certificates
            StringBuilder builder = new StringBuilder();
            builder.append("-----BEGIN CERTIFICATE-----\n");
            builder.append(strB64Cert);
            builder.append("\n-----END CERTIFICATE-----");
            String pemCert = builder.toString();
            
            ByteArrayInputStream istream = new ByteArrayInputStream(pemCert.getBytes("US-ASCII"));
